...
def main():
    global GUI_width, GUI_height, img_width, img_height, cropped_frameNumbers, cropped_frameX, imgLabel_list, pixel, videoLength
    global phaseNameList, img_list, letterCrops
